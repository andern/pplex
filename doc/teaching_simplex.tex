...
The basic variables being zero enforce values to the variables on the left
given by the constants in the linear equations.
Since all variables must be non-negative, we have
feasible and non-feasible dictionaries.
...
What do we concluded form the above example? It is not entirely useless to do some explicit
