...
for the objective function $x+y$. Thus our LP program is brought into the following form, 
...
It runs under Java 6 and Java 7 and is portable to any supporting platform.
