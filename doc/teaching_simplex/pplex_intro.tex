...
We are currently finishing a graphical interface illustrating \texttt{pplex} working on programs with two variables. 
...
We will make an effort to keep \texttt{pplex} up to date and will support 
